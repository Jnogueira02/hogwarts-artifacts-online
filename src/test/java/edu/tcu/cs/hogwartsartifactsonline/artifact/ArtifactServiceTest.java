...
import edu.tcu.cs.hogwartsartifactsonline.client.ai.chat.dto.client.ai.chat.ChatClient;
...
class ArtifactServiceTest {
    ...
    void setUp() {
        ...
        a2.setDescription("An invisibility claok is used to make the wearer invisible.");
